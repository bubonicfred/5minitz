...
const {MigrateV18} = proxyquire('../../../../server/migrations/migrate_v18', {
  ...
  '../../imports/services/minutesFinder' :
      {MinutesFinder, '@noCallThru' : true},
});

describe('Migrate Version 18', function() {
  let firstMinutes, secondMinutes, topicFirstAndSecondMinutes,
      topicFirstMinutes, topicSecondMinutes, itemFirstAndSecondMinutes,
      itemSecondMinutes;
  ...
  describe('#up', function() {
    ...
    it('calls the update method of the topics collection for each different topic and sets the new fields',
       function() {
         ...
         expect(TopicSchema.update.calledWith(topicFirstMinutes._id,
                                              expectedUpdateParamFirstMinutes))
             .to.be.true;
         expect(TopicSchema.update.calledWith(
    ...
    it('sets the createdAt/updatedAt fields for all items of each topic in the topics collection',
       function() {
         ...
         expect(argsFirstCall[1].$set.infoItems[0].createdAt)
             .to.equal(expectedDateForElementsCreatedInFirstMinutes);
       });
    ...
    it('updates each minutes and sets the createdAt/updatedAt fields for each topic',
       function() {
         ...
         expect(topcisFirstCall[0].createdAt.getTime())
             .to.equal(expectedDateForElementsCreatedInFirstMinutes.getTime());
         ...
         expect(topcis2ndCall[1].createdAt.getTime())
             .to.equal(expectedDateForElementsCreatedIn2ndMinutes.getTime());
    ...
    it('sets the createdAt/updatedAt field for all items of each topic in the minutes collection',
       function() {
         ...
         expect(topics2ndCall[1].infoItems[1].createdAt)
             .to.equal(expectedDateForElementsCreatedIn2ndMinutes);
  ...
  describe('#down', function() {
    ...
    it('deletes createdAt/updatedAt fields of all documents stored in the topics collection',
       function() {
         ...
         expect(TopicSchema.update.calledWith(topicFirstAndSecondMinutes._id, {
