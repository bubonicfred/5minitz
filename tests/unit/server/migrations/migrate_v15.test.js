...
describe('Migrate Version 15', function() {
  ...
  beforeEach(function() {
    ...
    topicOfMinute = {
      ...
      isNew : true,
      infoItems : [
        infoItem, actionItem1, actionItem2, actionItem3, actionItem4, infoItem2
      ]
    };
  ...
  const checkPriorities = (index, expectedValue) => {
    if (expectedValue === undefined) {
      expect(minute.topics[0].infoItems[index])
          .to.not.have.own.property('priority');
      expect(series.topics[0].infoItems[index])
          .to.not.have.own.property('priority');
      expect(series.openTopics[0].infoItems[index])
          .to.not.have.own.property('priority');
    }
    ...
    expect(series.openTopics[0].infoItems[index].priority)
