...
describe('Migrate Version 22', function() {
  describe('#up', function() {
    ...
    beforeEach(function() {
      ...
      const topicsOfFirstSeries = [
        {_id : topic1, parentId : 'ms#01'}, {_id : topic2, parentId : 'ms#01'}
      ];
    ...
    it('queries the meeting series collection once for each series id',
       function() {
         ...
         expect(MeetingSeriesSchema.findOne.calledWithExactly('ms#01'))
             .to.be.true;
         expect(MeetingSeriesSchema.findOne.calledWithExactly('ms#02'))
             .to.be.true;
       });
  });
  ...
  describe('#down', function() {
    it('should exist',
       function() { expect(MigrateV22).to.have.ownProperty('down'); });
  });
});