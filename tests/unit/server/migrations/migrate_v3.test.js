...
const {MigrateV3} = proxyquire(
    '../../../../server/migrations/migrate_v3',
  ...
  describe('#up', function() {
    it('adds the isSticky flag for each info item in minutes collection',
       function() {
         ...
         expect(minute.topics[0].infoItems[0].isSticky,
                "isSticky flag should be added")
             .to.be.false;
         expect(MinutesSchema.update.calledOnce,
    ...
    it('removes the isSticky flag for each info item in meeting series collection',
       function() {
         ...
         expect(
             ...
             .to.be.undefined;
         expect(MeetingSeriesSchema.update.calledOnce,
