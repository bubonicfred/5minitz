...
describe('Migrate Version 21', function() {
  describe('#up', function() {
    ...
    beforeEach(function() {
      ...
      TopicsFinder.allTopicsOfMeetingSeries.withArgs(meetingSeries._id)
          .returns(topicsOfFirstSeries);

      MinutesFinder.firstMinutesOfMeetingSeries.withArgs(meetingSeries)
  ...
  describe('#down', function() {
    it('should exist',
       function() { expect(MigrateV21).to.have.ownProperty('down'); });
  });
});