...
describe('Topics Skip', function() {
  ...
  it('Skipped topics will not be included in agenda mails', function() {
    ...
    expect(sentMail.html, 'the email should contain the subject of the topic')
  ...
  it('Skipped topics will not be included in info item mails', function() {
    ...
    E2ETopics.addInfoItemToTopic(
        {subject : nonSkippedInfoItemTitle, itemType : 'infoItem'}, 1)
    E2ETopics.addInfoItemToTopic(
        {subject : skippedInfoItemTitle, itemType : 'infoItem'}, 2)
