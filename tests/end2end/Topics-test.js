...
describe("Topics", function () {
  ...
  it("shows security question before deleting a topic", function () {
    ...
    let dialogContentElement = browser.element(selectorDialog + " .modal-body")
      .value.ELEMENT;
  ...
  it.skip("can not change the order of topics on the topics page", function () {
    ...
    let visibleTextBeforeSortAttempt = browser.elementIdText(
    ...
    let visibleTextAfterSortAttempt = browser.elementIdText(
  ...
  it.skip("sorting of topics is persistent", function () {
    ...
    let visibleTextBeforeReload = browser.elementIdText(
    ...
    let visibleTextAfterReload = browser.elementIdText(
  ...
  it("can collapse a topic", function () {
    ...
    let firstVisibleInfoItemText = browser.elementIdText(
