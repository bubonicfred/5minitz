...
describe('Routing', function() {
  ...
  it('ensures that "legal notice" route shows expected text', function() {
    expect(browser.isVisible('div#divLegalNotice'),
    ...
    expect(browser.getUrl(), 'on \'legal notice\' route')
        .to.contain('/legalnotice');
    expect(browser.isVisible('div#divLegalNotice'),
           'legal notice should be visible')
        .to.be.true;
    expect(browser.getText('div#divLegalNotice'),
  ...
  it('ensures that "legal notice" route is reachable on login screen via About dialog',
     function() {
       ...
       expect(browser.getUrl(), 'on normal route')
           .not.to.contain('/legalnotice');
