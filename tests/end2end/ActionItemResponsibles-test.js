...
describe('ActionItems Responsibles', function() {
  ...
  it('can add an action item with a responsible', function() {
    ...
    expect(actionItemExpandElementText, 'user1 shall be responsible')
        .to.have.string(user1)
  })

  it('can add an action item with two responsibles', function() {
    const topicIndex = 1
    const user1 = E2EGlobal.SETTINGS.e2eTestUsers[0] const user2 =
    ...
    expect(actionItemExpandElementText, 'user1 shall be responsible')
        .to.have.string(user1)
    expect(actionItemExpandElementText, 'user2 shall be responsible')
  ...
  it('prohibits non-email-string as free-text responsible', function() {
    ...
    E2EGlobal.waitSomeTime()
    expect(browser.getText('h4.modal-title').pop(),
    ...
    expect(actionItemExpandElementText, 'no illegal responsible added')
