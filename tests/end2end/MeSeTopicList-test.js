...
describe('MeetingSeries complete Topic list', function() {
  ...
  it('copies all topics of the first minute to the parent series including both all info- and actionItems.',
     function() {
       ...
       E2ETopics.addInfoItemToTopic(
           {subject : 'some action item', itemType : 'actionItem'}, 1);
  ...
  it('remains the topic open if it were neither discussed nor has open AI',
     function() {
       ...
       expect(E2ETopics.isTopicClosed(1), 'Topic should remain open')
           .to.be.false;
     });
  ...
  it('Reopen a Topic if there is no currently unfinalized Minute', function() {
    ...
    // a minute which is opened after reopening the topic should contain the
    // topic
    E2EMinutes.gotoParentMeetingSeries();
    E2EMinutes.addMinutesToMeetingSeries(aProjectName, aMeetingName);
    E2EMinutes.gotoLatestMinutes();
  ...
  describe('merge topics', function() {
    ...
    it('adds new topics and AIs/IIs to the topic list of the meeting series',
       function() {
         ...
         E2ETopics.addInfoItemToTopic(
             {subject : 'some other action item', itemType : 'actionItem'}, 1);

         // add a new topic
         E2ETopics.addTopicToMinutes('some other topic');
         E2ETopics.addInfoItemToTopic({subject : 'with information'}, 1);
         E2ETopics.addInfoItemToTopic(
             {subject : 'with an action item', itemType : 'actionItem'}, 1);
         ...
         expect(E2ETopics.countItemsForTopic(1),
         ...
         expect(E2ETopics.countItemsForTopic(2),
    ...
    it('closes an existing open AI but remains the topic open if it were not discussed',
       function() {
         ...
         expect(E2ETopics.isTopicClosed(1), 'Topic should remain open')
             .to.be.false;
         expect(E2ETopics.isActionItemClosed(1, 1), 'AI should be closed')
             .to.be.true;
       });
    ...
    it('closes an existing open AI and closes the topic if it were discussed',
       function() {
         ...
         expect(E2ETopics.isTopicClosed(1), 'Topic should be closed')
             .to.be.true;
         expect(E2ETopics.isActionItemClosed(1, 1), 'AI should be closed')
             .to.be.true;
       });
    ...
    it('changes the properties (subject/responsible) of an existing Topic',
       function() {
         ...
         expect(browser.elementIdText(topicEl).value,
    ...
    it('changes the properties (subject/responsible) of an existing AI',
       function() {
         ...
         E2ETopics.editInfoItemForTopic(
             1, 1, {subject : newSubject, responsible : newResponsible});
