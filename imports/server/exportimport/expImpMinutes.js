...
class ExpImpMinutes {
  ...
  /**
   * Export minutes of a meeting series to a file and collect additional user IDs.
   ...
   * @returns {Promise<Object>} A promise that resolves with the database object and the collected user IDs.
