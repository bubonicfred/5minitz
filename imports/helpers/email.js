 ...
 * @returns {boolean} `true` if the input string matches the email address regular expression, `false` otherwise.
 */
 ...
 * This includes common email address formats like `example@domain.com` and `user.name@subdomain.example.com`.
 */
