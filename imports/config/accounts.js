...
for (var lang of availLanguages) {
  T9n.map(lang, {
    custom : {
      usernamePlaceholder :
          i18n.__('Accounts.usernamePlaceholder', {_locale : lang}),
      ...
      passwordPlaceholder :
          i18n.__('Accounts.passwordPlaceholder', {_locale : lang}),
...
AccountsTemplates.addFields([
  {
    ...
    placeholder : {signUp : 'custom.usernamePlaceholder'},
    required : true,
    minLength : 3
  },
  {
    ...
    placeholder : {signUp : 'custom.namePlaceholder'},
  },
  {
    _id : 'email',
    type : 'email',
    ...
    placeholder : {default : 'emailAddress'},
    re : /^[^\s@]+@([^\s@]+){2,}\.([^\s@]+){2,}$/,
...

  {
    _id : 'password',
    type : 'password',
    placeholder : {default : 'password', signUp : 'custom.passwordPlaceholder'},
    required : true,
    minLength : 6,
