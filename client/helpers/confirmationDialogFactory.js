...
export class ConfirmationDialogFactory {
  ...
  static makeWarningDialog(
    ...
    return new ConfirmationDialog(
      {
        title: title || i18n.__("Dialog.ConfirmDelete.title"),
        content: content || i18n.__("Dialog.ConfirmDelete.body"),
        templateData: templateData,
        confirmButtonText: confirmButtonText || i18n.__("Buttons.delete"),
      },
      {
        onSuccess: onSuccess,
      }
